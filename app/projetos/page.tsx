...
const webDevProjects = [
    ...
    {
        title: "Portfólio de Fotografia Fine Art",
        description: "Landing page premium e cinematográfica para fotógrafos. Design imersivo focado em impacto visual, com animações fluidas de scroll, glassmorphism e galeria interativa.",
